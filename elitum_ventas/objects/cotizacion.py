...
class SaleOrder(models.Model):
    ...
    @api.multi
    def sent_quotation_customer(self):
        # Enviar Cotización/Pedido de Venta por correo
        self.ensure_one()
        ir_model_data = self.env['ir.model.data']
        try:
            template_id = ir_model_data.get_object_reference('elitum_ventas', 'eliterp_template_quotation_sale')[1]
        except ValueError:
            template_id = False
        try:
        ...
        ctx.update({
            ...
            'custom_layout': "elitum_ventas.eliterp_mail_template_data_notification_sale_order"
        })
        return {
            'type': 'ir.actions.act_window',
            'view_type': 'form',
    ...
    def _prepare_invoice(self):
        ...
        invoice_vals = {
            ...
            'consultant_sale_id': self.consultant_sale_id.id  # Cambio de método original
        }
        return invoice_vals
